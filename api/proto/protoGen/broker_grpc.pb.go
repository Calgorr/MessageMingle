...
type BrokerClient interface {
	...
	InternalPublish(ctx context.Context, in *PublishRequest, opts ...grpc.CallOption) (*PublishResponse, error)
}
...
func (c *brokerClient) InternalPublish(ctx context.Context, in *PublishRequest, opts ...grpc.CallOption) (*PublishResponse, error) {
	out := new(PublishResponse)
	err := c.cc.Invoke(ctx, "/broker.Broker/InternalPublish", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type BrokerServer interface {
	...
	InternalPublish(context.Context, *PublishRequest) (*PublishResponse, error)
...
func (UnimplementedBrokerServer) InternalPublish(context.Context, *PublishRequest) (*PublishResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method InternalPublish not implemented")
}
...
func _Broker_InternalPublish_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(PublishRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(BrokerServer).InternalPublish(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/broker.Broker/InternalPublish",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(BrokerServer).InternalPublish(ctx, req.(*PublishRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var Broker_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _Broker_InternalPublish_Handler,
		},
	},
	...
	Metadata: "api/proto/pb/broker.proto",
}
